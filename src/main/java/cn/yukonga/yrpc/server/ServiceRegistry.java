...
public class ServiceRegistry implements ApplicationContextAware {
    ...
    private void createServiceAddressNode(String serviceName) {
        ...
        String serverHost = registerServerConfig.getNetty().getHost();
        int serverPort = registerServerConfig.getNetty().getPort();
    ...
    private String rootPath() {
        return registerServerConfig.getZookeeper().getRootPath();
    }
